...
def compute_cost_with_regularization(A3, Y, parameters, lambd):
    ...
    ### START CODE HERE ### (approx. 1 line)4
...
def forward_propagation_with_dropout(X, parameters, keep_prob = 0.5):
    ...
    A1 = (A1*D1)/keep_prob                            # Step 3: shut down some neurons of A1
    ...
    A2 = (A2*D2)/keep_prob                                  # Step 3: shut down some neurons of A2
...
def backward_propagation_with_dropout(X, Y, cache, keep_prob):
    ...
    dA2 *= D2/keep_prob     # Step 1: Apply mask D2 to shut down the same neurons as during the forward propagation
    ...
    dA1 = np.dot(W2.T, dZ2)
    ### START CODE HERE ### (≈ 2 lines of code)
    dA1 *= D1/keep_prob                # Step 1: Apply mask D1 to shut down the same neurons as during the forward propagation
                                       # Step 2: Scale the value of neurons that haven't been shut down
    ### END CODE HERE ###
    dZ1 = np.multiply(dA1, np.int64(A1 > 0))
